...
Namespace DisabledEditors
	Public Class MyRadMaskedEditBox
		...
		Protected Overrides Sub CreateChildItems(ByVal parent As Telerik.WinControls.RadElement)
			...
			mtb.Font = Me.Font
			Me.MaskedEditBoxElement.Children.Add(tbi)
		End Sub

		Protected Overrides Sub OnEnabledChanged(ByVal e As EventArgs)
			If Not Me.Enabled Then
				tbi.Text = Me.Text
				Me.MaskedEditBoxElement.TextBoxItem.Visibility = Telerik.WinControls.ElementVisibility.Hidden
			Else
				Me.MaskedEditBoxElement.TextBoxItem.Visibility = Telerik.WinControls.ElementVisibility.Visible
			End If
