...
Namespace GridViewCustomCells
	Public Class IndicatedMultiComboBoxCellElement
		...
		Protected Overrides Sub OnCellFormatting(ByVal e As CellFormattingEventArgs)
			...
			If indicator IsNot Nothing Then
				indicator.Visibility = If(CType(Me.ColumnInfo, IndicatedMultiComboBoxColumn).EnableIndicator = True, ElementVisibility.Visible, ElementVisibility.Collapsed)
			End If
		End Sub
		...
		Private Sub grid_CellEditorInitialized(ByVal sender As Object, ByVal e As GridViewCellEventArgs)
			If Editor IsNot Nothing Then
                ...
                Dim currentEditor As RadMultiColumnComboBoxElement = TryCast(e.ActiveEditor, RadMultiColumnComboBoxElement)

                currentEditor.PopupForm.AnimationEnabled = False
                currentEditor.ShowPopup()
			End If
		End Sub
		...
		Public Overrides Function IsCompatible(ByVal data As GridViewColumn, ByVal context As Object) As Boolean
			Return TypeOf data Is IndicatedMultiComboBoxColumn AndAlso TypeOf context Is GridDataRowElement
		End Function
	End Class
End Namespace