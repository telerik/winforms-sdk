...
Namespace GridViewCustomCells
	Public Class IndicatedCalculatorCellElement
		Inherits GridCalculatorCellElement

		Private indicator As RadCalculatorArrowButtonElement
		...
		Public Sub New(ByVal column As GridViewColumn, ByVal row As GridRowElement)
			...
			Dim sg As StyleGroup = theme.FindStyleGroup("Telerik.WinControls.UI.RadCalculatorDropDown")
		...
		Protected Overrides Sub OnCellFormatting(ByVal e As CellFormattingEventArgs)
			...
			If indicator IsNot Nothing Then
				indicator.Visibility = If(CType(Me.ColumnInfo, IndicatedCalculatorColumn).EnableIndicator = True, ElementVisibility.Visible, ElementVisibility.Collapsed)
			End If
		End Sub
		...
		Private Sub grid_CellEditorInitialized(ByVal sender As Object, ByVal e As GridViewCellEventArgs)
            Dim currentEditor As RadCalculatorEditor = TryCast(e.ActiveEditor, RadCalculatorEditor)
            If currentEditor IsNot Nothing Then
                ...
                Dim element As RadCalculatorEditorElement = TryCast(currentEditor.EditorElement, RadCalculatorEditorElement)
		...
		Protected Overrides ReadOnly Property ThemeEffectiveType() As Type
			Get
				Return GetType(GridCalculatorCellElement)
			End Get
		End Property

		Public Overrides Function IsCompatible(ByVal data As GridViewColumn, ByVal context As Object) As Boolean
			Return TypeOf data Is IndicatedCalculatorColumn AndAlso TypeOf context Is GridDataRowElement
		End Function
	End Class
End Namespace