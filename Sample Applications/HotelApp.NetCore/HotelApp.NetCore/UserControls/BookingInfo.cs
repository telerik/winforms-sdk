...
namespace CustomControls
{
    public partial class BookingInfo : UserControl
    {
        ...
        public BookingInfo()
        {
            ...
            this.closeButton.Image = HotelApp.NetCore.Resource1.not_clean;
            
            this.bookingNameLabel.Image = HotelApp.NetCore.Resource1.edit;
        ...
        internal void LoadBookingInfo(Booking booking, BindingList<Room> rooms)
        {
            ...
            if (this.bookingDatesGrid.Columns.Count == 0)
            {
                ...
                {
                    c.HeaderImage = HotelApp.NetCore.Resource1.GlyphCalendar_small;
