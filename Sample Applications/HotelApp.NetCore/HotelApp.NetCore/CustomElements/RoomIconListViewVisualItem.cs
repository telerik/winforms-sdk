    ...
    public class RoomIconListViewVisualItem : IconListViewVisualItem
    {
        ...
        protected override void SynchronizeProperties()
        {
            ...
            { 
                ...
                needsRepair.Image = Resource1.GlyphWrench;
                bookingDuration.Image = Resource1.GlyphCalendar_small;
                if (room.HouseKeepingStatus == HouseKeepingStatus.NotClean)
                {
                    houseKeepingInfo.Image = Resource1.GlyphClose;
                }
                else
                {
                    houseKeepingInfo.Image = Resource1.GlyphCheck_small;
                }
