...
This Software (as defined below) is licensed to You for use with validly licensed Telerik UI Products only. Telerik UI Products are those Telerik Products containing the designation “UI” within the product name. This Agreement is a license agreement and not an agreement for sale. This Agreement does not grant You a license or any rights to use or distribute Telerik UI Products. To obtain more information about Telerik UI Products and/or to obtain a license for one or more Telerik UI Products please visit [www.telerik.com](http://www.telerik.com/).
